...
var MarketAssetsTable = React.createClass({
	...
	render: function() {
		...
		if (headers && this.props.data) {			
			...
			.map(function(asset) {
				return (
					React.createElement(MarketAssetRow, {key: asset._id, data: asset})
					);
			...
			return (
				...
				React.createElement(MarketAssetHeaderRow, {onSortClick: this.handleSortClick, headers: headers, sortIndex: sortIndex, inverse: inverse})
				), 
