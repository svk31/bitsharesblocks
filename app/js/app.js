...
.config(['$locationProvider','$compileProvider','$translateProvider',
    function ($locationProvider, $compileProvider,$translateProvider) {
        ...
        $translateProvider                
        .useLoader('customStaticFilesLoader',{'prefix':'locale-','suffix':'.json'})
        .use('en')
        .fallbackLanguage('en')
